...
void menu(){
    ...
    cout<<" 6. Game có số lượt tải lớn nhất"<<endl;
    cout<<" 7. Game có số lượt tải nhỏ nhất"<<endl;
    ...
    do
    {
        lai:
            ...
            switch(luachon){
                ...
                case 6:lonnhat(st);break;
                case 7:nhonhat(st);break;
                case 8: cout<<"Đang thoát chương trình ...";break;
                default:
